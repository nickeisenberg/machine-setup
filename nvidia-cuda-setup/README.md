...
will there will be several options. Make sure that you unselect the driver
option. We do not want to install this driver. The other options, which include
the cuda tool kit are the ones we want. Then hit install and this will install.
After install you will need to add these to your bash profile
```
